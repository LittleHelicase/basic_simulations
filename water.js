...
// force on p1 due to the potential.. probably found it somewhere else or experimented?
// you can use the lennard-jones potential, but you would have to adapt parameters
...
function gravity(){
  return [0, 100*m] // the mass gets canceled out again when calculating acceleration.
}
...
// if you run this on your terminal it will generate vtk files instead
